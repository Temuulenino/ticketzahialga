  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'shine': 'linear-gradient(105deg, transparent 40%, rgba(255,255,255,0.07) 45%, transparent 50%)',
      },
      backdropBlur: {
        xs: '2px',
        '2xl': '40px',
      ...
      boxShadow: {
        ...
        'glass-hover': '0 8px 48px 0 rgba(99, 102, 241, 0.4)',
        glow: '0 0 30px rgba(99, 102, 241, 0.5)',
        'glow-pink': '0 0 30px rgba(236, 72, 153, 0.5)',
        neon: '0 0 10px rgba(99, 102, 241, 0.8), 0 0 20px rgba(99, 102, 241, 0.4)',
